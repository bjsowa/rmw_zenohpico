...
static rmw_ret_t take_one(rmw_zenohpico_subscription_t* sub_data, void* ros_message, bool* taken,
                          rmw_message_info_t* message_info) {
  z_owned_slice_t msg_data;
  if (rmw_zenohpico_subscription_pop_next_message(sub_data, &msg_data) != RMW_RET_OK) {
  ...
  if (message_info != NULL) {
    ...
    message_info->publisher_gid.implementation_identifier = rmw_zenohpico_identifier;
...
static rmw_ret_t take_one_serialized(rmw_zenohpico_subscription_t* sub_data,
